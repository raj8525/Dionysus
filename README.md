...
1. CLI Adapter 接入 Claude Code / Gemini CLI / OpenCode。
2. Spec/Test Gatekeeper。
3. Worker isolated workspace 与 patch queue。
4. Milestone Detector 自动判定。
5. E2E Campaign Manager。
6. Email / Telegram Notification Delivery。
7. Coupon 真实小功能试运行。
