...
import { evaluateReportOnlyReviewerOutputGate } from "./reviewer-output-gate.js";
...
describe("evaluateReportOnlyReviewerOutputGate", () => {
  ...
  it("does not gate patch-mode reviewer tasks", () => {
    expect(evaluateReportOnlyReviewerOutputGate({
